<div align="center">
    ...
    <h1>Tresdoce NestJs Toolkit - mextest</h1>
</div>
...
<div align="center">
    ...
    <img alt="GitHub package.json version" src="https://img.shields.io/github/package-json/v/tresdoce/tresdoce-nestjs-toolkit-test?filename=packages%2Fmextest%2Fpackage.json">
    <br/>
</div>
...
```
npm install @tresdoce-nestjs-toolkit/mextest
```

```
yarn install @tresdoce-nestjs-toolkit/mextest
```
